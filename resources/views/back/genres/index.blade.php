...
@section('utils')
    <div class="utils h-25 mt-3">
        ...
        <div class="buttons-group">
            <a class="btn-info p-2" href="{{ route('admin.genres.create') }}">{{ __('Create') }}</a>
        </div>
    </div>
@endsection
                ...
                <table class="table">
                    ...
                    @foreach($genres as $genre)
                        <tr>
                            ...
                            <td><a href="{{ route('admin.genres.edit', $genre) }}" class="btn btn-sm btn-info">Edit</a></td>
                            <td><a class="btn btn-danger btn-sm request-delete" href="{{ route('admin.genres.destroy', $genre) }}" datatype="delete">Delete</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
